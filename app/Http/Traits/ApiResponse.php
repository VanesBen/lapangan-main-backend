...
trait ApiResponse
{
    protected function successResponse(mixed $data = null, string $message = 'Pesan Sukses', int $code = 200): JsonResponse
    {
    ...
    protected function unauthorizedResponse(string $message = 'Anda tidak memiliki akses untuk mengubah data ini'): JsonResponse
    {
